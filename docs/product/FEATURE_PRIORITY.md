...
|---|---|---|
| Authentication | Register, Login, [Logout ตาม UF-03](./USER_FLOWS.md#uf-03-logout), age gate 18+, account status handling | ต้องมี identity, server-side session invalidation ที่ทดสอบได้ และป้องกันผู้ใช้อายุต่ำกว่าเกณฑ์ |
